export function ApplyDraftModal({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center pointer-events-none z-10 bg-gray-500 bg-opacity-75">
      <div className="max-w-sm w-full bg-white shadow-lg rounded-lg pointer-events-auto overflow-hidden p-6 dark:bg-gray-900">
        <div className="flex items-start">
          ...
          <div className="ml-3 mt-1">
            ...
            <div className="mt-4">
              <button onClick={onConfirm} className="relative flex-none rounded-md border border-turquoise-200 bg-turquoise-500 text-sm text-white font-medium leading-5 py-1.5 px-2 lg:px-4 focus:border-turquoise-400 focus:outline-none focus:shadow-outline dark:bg-gray-800 dark:border-turquoise-500 dark:focus:bg-gray-700 dark:focus:border-turquoise-500">
                Apply
              </button>
